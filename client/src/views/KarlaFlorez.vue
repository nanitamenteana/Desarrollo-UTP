...
<div class="ui three column grid">
  <div class="column">
    <div class="ui segment">
      <img class="img" src="../assets/t4.jpg" alt="">
    </div>
  </div>
</div>
<div class="info">
...
<p>Licenciado en formación de Ciencias Sociales en la Universidad Pedagógica Nacional. Destacado por su puntualidad, gran capacidad analítica, dinamismo y conocimientos. Conocimientos en redacción y estructuración de trabajos académicos e investigativos. Dominio de métodos pedagógicos y de enseñanza, acoplándose a las necesidades de los estudiantes. Experiencia como tutor apoyando estudiantes de primaria y bachillerato.</p>
