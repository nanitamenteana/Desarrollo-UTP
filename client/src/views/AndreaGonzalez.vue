...
<div class="ui three column grid">
  <div class="column">
    <div class="ui segment">
      <img class="img" src="../assets/t3.jpg" alt="">
    </div>
  </div>
</div>
<div class="info">
<h2>Andrea González</h2>
<h3>Tutora</h3>
<a href="https://www.linkedin.com/in/tutor1/" target="_blank"><img class="linkedin" src="../assets/linkedin.png" alt=""></a>
<p>Matemática de la Universidad Nacional de Colombia como tutora de matemáticas financieras y aplicadas a la economía. Cálculo diferencial , cálculo integral, cálculo en varias variables, ecuaciones diferenciales.</p>
